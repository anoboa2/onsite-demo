...
const AppPreviews = [
  {
    header: <Typography variant="h2" fontWeight="300" >You Value Price Transparency <Box component="span" sx={{ color:"primary.contrastText", marginRight: { xs: 15, sm: 29 } }} ><br /><b>We Value You</b></Box></Typography>,
  ...
  // },
  {
    header: <Typography variant="h2" fontWeight="300" >Everything in one <Box component="span" sx={{ color:"primary.contrastText" }} ><b>Place</b></Box></Typography>,
