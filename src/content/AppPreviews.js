...
const AppPreviews = [
  {
    header: <Typography variant="h2" >You Value Price Transparency <Box component="span" sx={{ color: "primary.main", borderBottom: "3px solid #0FAACD", marginRight: { xs: 15, sm: 29 } }} ><br />We Value You</Box></Typography>,
    ...
    image: <Box marginLeft={4} component="img" src="/img/content/itinerary-desktop-mockup.png" alt="" sx={{ height: { xs: 300, sm: 400 }, width: { xs: 380, sm: 600 }, marginTop: { xs: 7, sm: 8 } , marginBottom: { xs: -2, sm: 8 } , marginLeft:{ xs: 0, sm: 4} }} />,
  ...
  // },
  {
    header: <Typography variant="h2" >Everything in one <Box component="span" sx={{ color: "primary.main", borderBottom: "3px solid #0FAACD" }} >Place</Box></Typography>,
