        ...
        <Grid container columns={{ xs: 6, sm: 12, }} spacing={0} sx={{ ml: 'auto', mr: 'auto', pb: 5, pt: 6, pl: 4, pr: 4}} >
            <Grid item xs={6}>
                <Box sx={{ width: '100%', justifySelf: 'center' }}>
                    <Typography color="black" sx={{ mb: 2, }}>When are you planning to travel?</Typography>
            ...
            <Grid item xs={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', maxWidth: '275px', }}>
                <InputLabel id="location-label" sx={{ width: '100%', maxWidth: '300px', mb: 2, mt: { xs: 4, sm: 0, } }}>What destination are you traveling to?</InputLabel>
                <Select
