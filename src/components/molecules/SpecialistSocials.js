...
const SpecialistSocials = ({ socials }) => {
  ...
  return (
    <Stack spacing={1} direction="column">
      {socials.instagram && (
        <Link href={`https://instagram.com/${socials.instagram}`} sx={{ display: 'flex' }}>
          <Box sx={ iconStyle }>
      ...
      {socials.tiktok && (
        <Link href={`https://tiktok.com/@${socials.tiktok}`} sx={{ display: 'flex' }}>
          <Box sx={ iconStyle }>
      ...
      {socials.twitter && (
        <Link href={`https://twitter.com/${socials.twitter}`} sx={{ display: 'flex' }}>
          <Box sx={ iconStyle }>
      ...
      {socials.youtube && (
        <Link href={`https://youtube.com/${socials.youtube}`} sx={{ display: 'flex' }}>
          <Box sx={ iconStyle }>
