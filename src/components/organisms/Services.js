...
const Services = () => {
  ...
  return (
    <Grid container spacing={3} sx={{ px: "15%", py: 5, mb: 10, overflow: "hidden" }}>
      <Grid item xs={18} sx={{ display: "flex", flexDirection: "column", mb: 5 }}>
      ...
      {ServicesOffered.map((service, index) => (
        <Grid item xs={18} sm={6} key={index} sx={{ display: "flex", justifyContent: "center" }}>
          <ServiceCard {...service} />
        </Grid>
      ))}
    </Grid>
