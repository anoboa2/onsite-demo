...
const content = [
  ...
  },
  {
    order: 3,
    title: 'Collaborate',
    description: 'Provide any feedback, questions, or changes to the itinerary and your specialist will quickly provide updates until you are 100% satisfied.',
...
const HowItWorks = () => {
  return (
    <Grid container spacing={6} sx={{ justifyContent: 'center', px: 10, mb: 16 }}>
    <Grid item xs={12}>
