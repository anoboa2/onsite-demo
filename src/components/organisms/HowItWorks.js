...
const HowItWorks = () => {
  return (
    <Box sx={{ display: 'block', maxWidth: '1440px', margin: 'auto'}} >
      <Typography variant="h2" align="center" sx={{ px: { xs: 2, sm: "20%" }, py: 5, mb: -1, color:"primary.main" }}>
        How Onsite works for you
      </Typography>
      <Grid container spacing={3} sx={{ justifyContent: 'space-evenly', mb: 13, maxWidth: '100%', overflow: 'hidden' }}>
