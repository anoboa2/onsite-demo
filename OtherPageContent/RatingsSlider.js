...
const itemData = [
    ...
    },
    {
        ...
        img: "https://images.unsplash.com/photo-1551782450-a2132b4ba21d",
        title: 'Burger',
        details: "Izanna helped us plan our babymoon during peak tourist with only a month to spare. She was highly responsive, personal and truly listened to our unique needs! Would definitely recommend. ",
        name: "-Taylor R.",
        rating: 5
    },
    {
                                ...
                                {itemData.map((newData) => (<>
                                    <div style={{ margin: 20 }}>
                                        <Paper elevation={3} sx={{ borderRadius: "40px" }}>
                                            ...
                                            <Box paddingX={1} className={classes.mainbox} padding={4} sx={{ borderRadius: "20px" }}>
